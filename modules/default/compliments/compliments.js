	...
	defaults: {
		compliments: {
			anytime: [
				...
				"You're a whole vibe",
				"Excuse me, you're stunning",
				"You're my favorite notification",
				"Well hello, gorgeous!",
				"You're criminally attractive",
				"Looking illegal today!",
				"You're a walking thirst trap",
				"Main character energy!",
				"You're my type on paper",
				"Respectfully... wow!",
				"You're a certified cutie",
				"10/10 would swipe right",
				"Boss energy detected!",
				"King behavior only",
				"You radiate power today",
				"Built different, I see",
				"Alpha vibes strong today",
				"You own every room",
				"That's big boss energy",
				"Unstoppable force alert!",
				"You're crushing it, king",
				"Peak performance mode",
				"Champion mindset showing",
				"You're the main event",
				"Absolute unit!",
				"Leadership looks good on you",
				"Winner winner!",
				"You're operating on another level",
			...
			morning: [
				...
				"Enjoy your day!",
				"How was your sleep?",
				"Rise and shine, hottie!",
				"Morning, sunshine!",
				"Wake up, beautiful!",
				"Hello, bed head cutie",
				"Morning, you look cozy",
				"Rise and slay!",
				"Good morning, troublemaker",
				"Wakey wakey, gorgeous!",
				"Morning! Still cute, I see",
			...
			afternoon: [
				...
				"Midday and still slaying!",
				"Afternoon snack alert!",
				"Still killing it, I see",
				"Afternoon, legend!",
				"Halfway through and crushing it!",
